...
export default function RegisterPage() {
  ...
  const handleSubmit = (e) => {
    ...
    setTimeout(() => {
      toast.success("✓  Account created! Redirecting to login...", toastOpts);
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            <div>
              <div className="relative">
                <User className={"absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 " + themeClass("text-gray-500", "text-gray-400")} />
            ...
            <button type="submit" disabled={isLoading}
              className="w-full mt-6 py-3 rounded-lg bg-purple-600 text-white font-medium hover:bg-purple-700 transition flex items-center justify-center gap-2 disabled:opacity-50">
              {isLoading
